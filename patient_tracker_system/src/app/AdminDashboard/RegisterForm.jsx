...
export const RegisterForm = () => {
    ...
    const postNewDoctor = async (doc = {}) => {
        const response = await fetch("http://localhost:3001/newDoctor", {
            method: "Post",
            headers: {
    ...
    return (
        <form className = "register-form" style={{display: "flex", flexDirection: "column", alignItems: "center", alignSelf: "center"}}>
            <div>
                ...
                required
                />
                <label htmlFor="middle"><b>Middle Initial</b></label>
                <input 
                type="text" 
                ...
                <label htmlFor="ssn"><b>Social Security Number</b></label>
                <input 
                type="text" 
